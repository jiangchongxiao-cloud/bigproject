...
- **Due Date**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) then delete this comment -->Feb 26
...
I have selected the BladeBatteryArray component. The statistical probability of this component demonstrating the full value of the OSU software discipline is significantly higher than the GradeBook or MinecraftInventory components I previously wrote. The CTP (Cell-to-Pack) architecture inherently enforces a strict boundary between "kernel" state and "secondary" analytical functions. Implementing this MVP will directly resolve my previous uncertainty regarding whether secondary methods can be built entirely upon kernel state retrievals, serving as a high-fidelity proof of concept. And from my personal perspective, this component is more closely related to my Major ECE. Besides, I am a big fan of EVs. I really admire the enterprise that invented the CTP technology, BYD, a company with advanced technology and a sense of national sentiment. I hope to have a brief understanding of the world-leading technology through this project.
